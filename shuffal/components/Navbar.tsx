    ...
    <nav className="sticky top-0 z-40 px-6 py-4 backdrop-blur-md bg-slate-900/80 border-b border-slate-700/50">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 sm:gap-6">
          ...
          <button type="button" className="relative z-10 group" aria-label="View profile photo">
            <MemberAvatar
              name={user?.name}
              profileImage={profileImage}
              alt="Profile"
              className="relative flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border-2 border-slate-600 bg-gradient-to-br from-blue-500 to-purple-600 text-white font-bold transition duration-200 ease-out group-hover:scale-150 group-hover:border-blue-500 group-hover:ring-2 group-hover:ring-blue-400"
            />
          </button>
        </div>
      </div>
